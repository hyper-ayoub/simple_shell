 ...
 *@mydest: the destination string to be copied to
 *@mysrc: the source string
 ...
 *@mydest: the first string
 *@mysrc: the second string
 *@n: the amount of the bytes to be maximally used
 *Return: the concatenated string
 */
